...
format:
  ...
  pdf:
    ...
    include-in-header:
      - text: |
          % prevent LaTeX from printing the default title block
          \makeatletter
    ...
    include-before-body:
      - text: |
          ...
          \centering
          \vspace*{3cm}
          \includegraphics[width=1.0\textwidth]{images/Header.pdf} \par
          \vspace{2cm}
          {\Large\bfseries SC13 - JM09  Report of the Management Strategy Evaluation (MSE) workshop (SCW15), July 14-18, 2025 \par}
          \vspace{1cm}
          \vfill
